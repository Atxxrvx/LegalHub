          ...
          <div className="flex flex-wrap items-center sm:-mx-3">
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                ...
                <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                  <Link to="/auth">
                    <p className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-700 sm:mb-0 hover:bg-indigo-800 sm:w-auto rounded-2xl">
                      Get Started Now
                      <svg
            ...
            <div className="w-full md:w-1/2">
              <div className="w-full h-auto overflow-hidden shadow-xl rounded-2xl">
                <img src="https://LegalHub.vercel.app/_next/image?url=%2Fhero_img.jpeg&w=1920&q=75" alt="" />
              </div>
            </div>
          </div>
        </div>
